...
function loadConfig() {
  if (fs.existsSync(configPath)) {
    ...
    config.model = config.aiService === "Ollama" ? config.ollamaModel : config.chatgptModel; 
    return config;
  } else {
    return null;
  }
...
async function configure(
  ...
  while (!validConfig) {
    ...
    finalConfig.model = finalConfig.aiService === "Ollama" ? finalConfig.ollamaModel : finalConfig.chatgptModel;
    validConfig = true;
