...
(async () => {
  ...
  const aiPrompt = `I am at a command line on ${osType}. I need you to do the following ${command}  then format your response in the following json format. only return the json object.
